...
4. **Roll out — DONE (v0.124.0).** The full huge roster ships: **forest, rocky, desert, mushroom, frozen, meadow,
   ...
   a deepslate Ancient cave-host, …). Sizes/cave-density/recipe-bulk are first-pass — tune in playtest. **Phase 3
   (rare structures) is the remaining huge work** (the bigger Ocean Monument is in; Ancient City / large Mansion /
   dungeon menu in §3).

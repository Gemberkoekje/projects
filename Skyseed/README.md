...
| Themes (seeds) | **Forest** (`skyseed:forest`), **Large Forest** (`skyseed:forest_large`), **Rocky** (`skyseed:rocky`) |
...
**Not built:** the other 8 island types in [SKYISLANDSPLAN.md](SKYISLANDSPLAN.md) (Desert, Mushroom, Frozen, Meadow, Aquatic, Ancient, Badlands, Lush) — several currently exist as *Forest biome-overrides* rather than dedicated seeds. Nether/End skyblock dimensions are a long-term goal.

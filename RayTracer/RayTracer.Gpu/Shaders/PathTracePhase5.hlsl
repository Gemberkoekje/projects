...
// reflectance × (ambient + direct) at a diffuse surface reached through a mirror.
...
// Scalar spectral radiance (hero wavelength) arriving back along a specular ray.

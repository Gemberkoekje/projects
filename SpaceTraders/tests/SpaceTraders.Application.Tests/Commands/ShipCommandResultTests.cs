...
public sealed class ShipCommandResultTests
{
    ...
    [Fact]
    public async Task OrbitShip_WhenAccepted_DoesNotPublishShipAutomationTickEvent()
    {
        var port = Substitute.For<ISpaceTradersPort>();
        var ships = Substitute.For<IShipRepository>();
        var bus = Substitute.For<IMessageBus>();
    ...
    [Fact]
    public async Task DockShip_WhenAccepted_DoesNotPublishShipAutomationTickEvent()
    {
        var port = Substitute.For<ISpaceTradersPort>();
        var ships = Substitute.For<IShipRepository>();
        var bus = Substitute.For<IMessageBus>();

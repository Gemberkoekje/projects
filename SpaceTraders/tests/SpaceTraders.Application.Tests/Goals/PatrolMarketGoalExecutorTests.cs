...
/// <summary>
/// Phase 10: unit tests for <see cref="PatrolMarketGoalExecutor"/>.
/// </summary>
public sealed class PatrolMarketGoalExecutorTests
{
    ...
    private PatrolMarketGoalExecutor CreateExecutor() =>
    ...
    private static PatrolMarketGoal Goal(string target = "X1-AB-MKT") =>
        new() { TargetWaypointSymbol = target };

    [Fact]
    public void CanExecute_ReturnsTrue_ForPatrolMarketGoal()
    {
    ...
    [Fact]
    public async Task ExecuteStepAsync_Docked_AtTarget_RefreshesAndOrbits()
    {

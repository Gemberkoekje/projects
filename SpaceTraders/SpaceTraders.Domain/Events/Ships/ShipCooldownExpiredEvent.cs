...
/// <summary>
/// Published by <c>ShipEventScheduler</c> when a ship's scheduled cooldown expiry time has been reached.
...
public sealed record ShipCooldownExpiredEvent
{
    ...
    public ShipCooldownExpiredEvent(string shipSymbol, Guid goalId, DateTimeOffset occurredAt)
    {
